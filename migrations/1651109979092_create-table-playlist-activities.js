...
exports.down = (pgm) => {
  ...
  pgm.dropConstraint('playlist_activities', 'fk_playlist_activities.song_id_songs.id');
  pgm.dropConstraint('playlist_activities', 'fk_playlist_activities.user_id_users.id');
};
